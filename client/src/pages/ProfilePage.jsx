    ...
    <div className="w-full h-screen flex items-center justify-center lg:px-4">
      <div
        className="w-full h-full flex relative overflow-hidden
          lg:backdrop-blur-xl lg:rounded-lg lg:border-2 lg:border-black/20
          lg:max-w-7xl lg:max-h-[90vh]"
      >
        {/* Left — form panel, full screen on mobile */}
        <div
          className="w-full lg:max-w-2xl bg-black/90 backdrop-blur-2xl text-white/80 
        ...
        >
          ...
          <button
            onClick={() => navigate("/")}
            className="flex items-center gap-2 text-sm text-gray-400 hover:text-white transition mb-8 w-fit"
          >
            <ArrowLeft size={18} />
            Back to Chats
          </button>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <h3 className="font-semibold text-2xl text-white">Profile Details</h3>
            ...
            <textarea
              ...
              placeholder="Profile Bio"
              className="bg-transparent border border-gray-600 rounded-md !px-3 !py-2 
                focus:outline-none focus:ring-2 focus:ring-blue-500 transition resize-none text-white"
            />

            {/* Button */}
            <button
              className="bg-blue-500 hover:bg-blue-600 active:scale-95 text-white 
                font-bold !py-2.5 !px-4 rounded-md transition cursor-pointer"
            >
              Save Changes
            </button>
          </form>
